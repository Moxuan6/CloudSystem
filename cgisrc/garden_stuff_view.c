...
int cgiMain(int argc, const char *argv[])
{
	...
	if( 1 == msg.user.flags){
		...
		printf("<tr>");
		printf("<td bgcolor=\"#E55451\" width=\"80\" height=\"20\" style=\"text-align: center; font-size: 13px;\">上: %.2f°c</td>",msg.limitset.tempup);
		...
		printf("</tr>");
		printf("<tr>");
		printf("<td bgcolor=\"#00FF00\" width=\"80\" height=\"20\">%.2f°c</td>",msg.envdata.temp);
		...
		printf("</tr>");
		printf("<tr>");
		printf("<td bgcolor=\"yellow\" width=\"80\" height=\"20\" style=\"text-align: center; font-size: 13px;\">下: %.2f°c</td>",msg.limitset.tempdown);
